...
This project investigated how **implicit social biases influence empathic responses toward presumed rape victims**. Using facial cues as a subtle representation of socially constructed stereotypes, the study examined whether characteristics such as **prototypical appearance, skin tone, and place of residence** influence neural and behavioural responses to presumed rape victims.
...
The study highlights the value of combining **neural and behavioural measures** to uncover subtle biases that may not be apparent through self-report alone. It provides preliminary evidence that socially constructed perceptions of victims can influence empathic responses and highlights the importance of examining **implicit bias in responses to sexual violence**.

## Thesis & Conference Presentation

This research was conducted as part of my Master's by Research thesis.

[**View the thesis →**](https://ims-extr.iiit.ac.in/do.php?qxKcNGb3VaPgACp70OPd+yjdO1Ip4YROVLwyt8Cs047WII2/IrWglyabqG7wRQJAbhj9+JJOvIAmh2bUXPaTdtCtb7FrHdOpRbG40DB/eKirKjAAcOmG4BrpB+ttgSik5xnZtBztyDC5G2VEJxAnsA==)

The work was also presented at the **Organization for Human Brain Mapping (OHBM) Annual Meeting 2019**, held in Singapore.
